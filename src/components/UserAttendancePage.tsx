    ...
    try {
      ...
      for (const entry of extractedEntries) {
        ...
        await attendanceService.createManualAttendance({
          ...
          status: entry.status,
          locationId: entry.status === 'Hadir' && entry.locationId !== 'custom' ? entry.locationId : undefined,
    ...
    try {
      ...
      if (editingAttendance) {
        ...
        await attendanceService.updateManualAttendance(editingAttendance.id, {
          ...
          checkOut: checkOutIso,
          status,
          locationId: status === 'Hadir' && selectedGeofenceId !== 'custom' ? selectedGeofenceId : undefined,
          locationName: finalLocName,
          latitude: lat,
          longitude: lng,
          suratKeteranganUrl: finalSuratUrl,
