    ...
    <aside className="w-64 bg-white border-r border-slate-200 h-screen fixed left-0 top-0 overflow-y-auto hidden md:flex flex-col z-10">
      ...
      <nav className="flex-1 p-4 space-y-1">
        ...
        <button
          ...
          className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-colors duration-200 ${activeTab === 'Saran Masukan'
        ...
        {(currentUser.role === 'Super Admin' || currentUser.role === 'Atasan') && (
          <>
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-colors duration-200 ${activeTab === 'Activity Log'
                  ? 'bg-orange-50 text-orange-700'
                  : 'text-slate-600 hover:bg-orange-50 hover:text-orange-700'
                }`}
            >
              <Activity size={18} className={activeTab === 'Activity Log' ? 'text-orange-600' : 'text-slate-400'} />
              Activity Log
            </button>
            ...
            {currentUser.role === 'Super Admin' && (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-colors duration-200 ${activeTab === 'Master Data'
