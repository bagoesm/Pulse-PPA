// DivisionFilteredMultiSelect.tsx
// Multi-select dengan filter divisi - default hanya tampilkan user dari divisi yang sama
import React, { useState, useMemo } from 'react';
import { Users } from 'lucide-react';
import MultiSelectChip from './MultiSelectChip';
import { User } from '../../types';

interface DivisionFilteredMultiSelectProps {
  users: User[];
...
const DivisionFilteredMultiSelect: React.FC<DivisionFilteredMultiSelectProps> = ({
  users,
  currentUserDivisi,
  value,
  onChange,
...
export default DivisionFilteredMultiSelect;
