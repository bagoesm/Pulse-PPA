...
const NotificationModal: React.FC<NotificationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm">
      <div className={`bg-white rounded-2xl shadow-2xl w-full sm:max-w-lg overflow-hidden animate-in fade-in-0 zoom-in-95 duration-300 border-l-4 ${getBorderColor()}`}>
        {/* Header */}
